    ...
    class themeple_viewgen{
       ...
       var $used_for = 'admin_page';
        ...
        function page_option_header(){
            ...
            $output .= '</div>';
            $output .= '<div class="themeple_navigation"><div class="template_description">This is your theme optionspanel from here you can edit, add, delete or change everthingon the theme. If you need anysupport please contact u Thank You</div><ul></ul></div><div class="themeple_main_section">';

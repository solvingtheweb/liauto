   ...
   echo "Errors while loading classes. Please use the standart wordpress importer."; 
	...
	{  
	   ...
	   if(class_exists( 'WP_Import' )){
			...
			$our_class->import($import_filepath.'_2.xml');

			$our_class->import($import_filepath.'_3.xml');

			$our_class->import($import_filepath.'_4.xml');

			$our_class->import($import_filepath.'_5.xml');

			$our_class->import($import_filepath.'_6.xml');
			$our_class->import($import_filepath.'_7.xml');

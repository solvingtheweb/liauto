    ...
    function widget($atts, $instance){
		...
		if(themeple_backend_is_file($video, 'html5video'))
...

					{
						...
						$video_ .= '<iframe src="'.$video.'"></iframe>';
...
class SocialWidget extends WP_Widget{
    ...
    function widget($atts, $instance){
	 ...
	 if(isset($_COOKIE['themeple_skin']))
		$footer_logo = THEMEPLE_BASE_URL.'img/'.$_COOKIE['themeple_skin'].'/footer_logo.png';
        echo '<div class="row-fluid" style="margin-bottom:20px;"><div class="span12"><img src="'.$footer_logo.'" /></div></div>';
        	...
        	echo '<div class="span12">';
        		...
        		echo '<ul class="footer_social_icons">';
        			foreach($social_icons as $icon):
        				...
        				echo '<li class="'.$icon['social'].'"><a href="'.$icon['link'].'"><span></span></a></li>';
...
class FlickrWidget extends WP_Widget{
    ...
    function widget($atts, $instance){
        ...
        echo '<script type="text/javascript" src="http://www.flickr.com/badge_code_v2.gne?count=9&amp;display=latest&amp;size=s&amp;layout=x&amp;source=user&amp;user='.$user_id.'"></script>';
 ...
 function widget($atts, $instance){
      ...
      extract($atts, EXTR_SKIP);
        ...
        $content = empty($instance['content']) ? '' : $instance['content'];
             ...
             echo '<h5 class="widget-title">'.$title.'</h5>';

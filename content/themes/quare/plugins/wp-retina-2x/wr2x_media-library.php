...
function wr2x_manage_media_custom_column( $column_name, $id ) {
	...
	if ( wr2x_is_ignore( $id ) ) {
		echo "<img style='margin-top: -2px; margin-bottom: 2px; width: 16px; height: 16px;' src='" . trailingslashit( get_stylesheet_directory_uri() . '/plugins/' ) . trailingslashit( 'wp-retina-2x/img') . "tick-circle.png' />";
		return;
	}
	...
	if ( $required_files ) {
		...
		echo "<img title='Please upload a bigger original image.' style='margin-top: -2px; margin-bottom: 2px; width: 16px; height: 16px;' src='" . trailingslashit( get_stylesheet_directory_uri() . '/plugins/' ) . trailingslashit( 'wp-retina-2x/img') . "exclamation.png' />" .
		...
		echo "<img title='Click on \"Generate\".' style='margin-top: -2px; margin-bottom: 2px; width: 16px; height: 16px;' src='" . trailingslashit( get_stylesheet_directory_uri() . '/plugins/' ) . trailingslashit( 'wp-retina-2x/img') . "clock.png' />" .

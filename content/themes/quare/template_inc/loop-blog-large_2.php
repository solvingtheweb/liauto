...
if (have_posts()) :
	...
	while (have_posts()) : the_post();
        ...
        <article class="row-fluid blog-article large_2" id="post-<?php echo the_ID(); ?>" <?php echo post_class('entry'); ?>>                    
                                        ...
                                        <div class="media">
                                            ...
                                            <?php if($post_format == 'audio'){ ?>
                                                ...
                                                <audio controls="controls">
                                                  ...
                                                  <?php _e("Your browser does not support the audio element.", "themeple") ?>
                                            ...
                                            <?php } elseif(get_post_thumbnail_id()){ ?>
                                                ...
                                                <img src="<?php echo themeple_image_by_id(get_post_thumbnail_id(), array('width' => 657, 'height' => 247), 'url') ?>" alt="">
                                            
                                            <?php } ?>
                                            <div class="post_type"><span class="type-<?php echo $post_format ?>-img"></span></div>
                                        </div>
                                    </div>
                                    <div class="span6">
                                         <div class="content">
                                            ...
                                            <?php if(is_single()){ ?>
                                                     ...
                                                     <?php }else{
                                                        ...
                                                        <div class="row-fluid"><div class="span12"><a href="<?php echo get_permalink() ?>" class="btn default-btn pull-right"><span><?php _e("Read More", "themeple") ?></span> <span class="icon"></span></a></div></div>
                                            <?php } ?>

...
function header_register() 
{
	...
	$labels = array(
		...
		'add_new_item' => __('Add New Header Entry'),
		'edit_item' => __('Edit Header Entry'),
		'new_item' => __('New Header Entry'),
		'view_item' => __('View Header Entry'),
		'search_items' => __('Search Header Entries'),
		'not_found' =>  __('No Header Entries found'),
		'not_found_in_trash' => __('No Header Entries found in Trash'), 
		'parent_item_colon' => ''
	);

...
function staff_register() 
{
	...
	$labels = array(
		...
		'add_new_item' => __('Add New Staff Entry'),
		'edit_item' => __('Edit Staff Entry'),
		'new_item' => __('New Staff Entry'),
		'view_item' => __('View Staff Entry'),
		'search_items' => __('Search Staff Entries'),
		'not_found' =>  __('No Staff Entries found'),
		'not_found_in_trash' => __('No Staff Entries found in Trash'), 
		'parent_item_colon' => ''
	);
